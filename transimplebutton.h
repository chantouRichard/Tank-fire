#ifndef TRANSIMPLEBUTTON_H
#define TRANSIMPLEBUTTON_H
...
class transimplebutton : public QPushButton
{
    Q_OBJECT
public:
    ...
    explicit transimplebutton(QWidget *parent = nullptr, AnimationType animationType = AnimationType::CircularFill);
    explicit transimplebutton(const QString &text, QWidget *parent = nullptr, AnimationType animationType = AnimationType::CircularFill);
    transimplebutton(const QIcon &icon, const QString &text, QWidget *parent = nullptr, AnimationType animationType = AnimationType::CircularFill);
