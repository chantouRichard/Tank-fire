...
void EnemyTank::updatePosition() {
    ...
    case 90: // Right
        ...
        if(enemytank_style==1){
            Enemy_Tank.load(EnemyTankRight);
            enemy_tank_img->setPixmap(Enemy_Tank);
        }
        else if(enemytank_style==2){
            Enemy_Tank.load(EnemyTankRight);
...
bool EnemyTank::irremovable() {
    ...
    if(MAP_Global[map_enemy_tanky1][map_enemy_tankx1-1]==4||MAP_Global[map_enemy_tanky1][map_enemy_tankx1-1]==0||MAP_Global[map_enemy_tanky1][map_enemy_tankx1-1]>10){
        check1=0;
    }
    if(MAP_Global[map_enemy_tanky2][map_enemy_tankx2-1]==4||MAP_Global[map_enemy_tanky2][map_enemy_tankx2-1]==0||MAP_Global[map_enemy_tanky2][map_enemy_tankx2-1]>10){
        check2=0;
    }
    if(MAP_Global[map_enemy_tanky1][map_enemy_tankx1+1]==4||MAP_Global[map_enemy_tanky1][map_enemy_tankx1+1]==0||MAP_Global[map_enemy_tanky1][map_enemy_tankx1+1]>10){
        check3=0;
    ...
    if(MAP_Global[map_enemy_tanky1-1][map_enemy_tankx1]==4||MAP_Global[map_enemy_tanky1-1][map_enemy_tankx1]==0||MAP_Global[map_enemy_tanky1-1][map_enemy_tankx1]>10){
        check5=0;
    }
    if(MAP_Global[map_enemy_tanky4-1][map_enemy_tankx4]==4||MAP_Global[map_enemy_tanky4-1][map_enemy_tankx4]==0||MAP_Global[map_enemy_tanky4-1][map_enemy_tankx4]>10){
        check6=0;
    }
    if(MAP_Global[map_enemy_tanky1+1][map_enemy_tankx1]==4||MAP_Global[map_enemy_tanky1+1][map_enemy_tankx1]==0||MAP_Global[map_enemy_tanky1+1][map_enemy_tankx1]>10){
        check7=0;
    ...
    if(MAP_Global[map_enemy_tanky1][map_enemy_tankx1]==4||MAP_Global[map_enemy_tanky1][map_enemy_tankx1]==0||MAP_Global[map_enemy_tanky1][map_enemy_tankx1]>10){
        check9=0;
    }
    if(MAP_Global[map_enemy_tanky2][map_enemy_tankx2]==4||MAP_Global[map_enemy_tanky2][map_enemy_tankx2]==0||MAP_Global[map_enemy_tanky2][map_enemy_tankx2]>10){
        check10=0;
    }
    if(MAP_Global[map_enemy_tanky3][map_enemy_tankx3]==4||MAP_Global[map_enemy_tanky3][map_enemy_tankx3]==0||MAP_Global[map_enemy_tanky3][map_enemy_tankx3]>10){
        check11=0;
    }
    if(MAP_Global[map_enemy_tanky4][map_enemy_tankx4]==4||MAP_Global[map_enemy_tanky4][map_enemy_tankx4]==0||MAP_Global[map_enemy_tanky4][map_enemy_tankx4]>10){
        check12=0;
    }
