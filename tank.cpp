...
bool Tank::irremovable()
{
    ...
    if(MAP_Global[maptanky1-1][maptankx1]==4||MAP_Global[maptanky1-1][maptankx1]==0||MAP_Global[maptanky1-1][maptankx1]>10){
        check1=0;
    }
    if(MAP_Global[maptanky2-1][maptankx2]==4||MAP_Global[maptanky2-1][maptankx2]==0||MAP_Global[maptanky2-1][maptankx2]>10){
        check2=0;
    }
    if(MAP_Global[maptanky1+1][maptankx1]==4||MAP_Global[maptanky1+1][maptankx1]==0||MAP_Global[maptanky1+1][maptankx1]>10){
        check3=0;
    ...
    if(MAP_Global[maptanky1][maptankx1-1]==4||MAP_Global[maptanky1][maptankx1-1]==0||MAP_Global[maptanky1][maptankx1-1]>10){
        check5=0;
    }
    if(MAP_Global[maptanky4][maptankx4-1]==4||MAP_Global[maptanky4][maptankx4-1]==0||MAP_Global[maptanky4][maptankx4-1]>10){
        check6=0;
    }
    if(MAP_Global[maptanky1][maptankx1+1]==4||MAP_Global[maptanky1][maptankx1+1]==0||MAP_Global[maptanky1][maptankx1+1]>10){
        check7=0;
    ...
    if(MAP_Global[maptanky1][maptankx1]==4||MAP_Global[maptanky1][maptankx1]==0||MAP_Global[maptanky1][maptankx1]>10){
        check9=0;
    }
    if(MAP_Global[maptanky2][maptankx2]==4||MAP_Global[maptanky2][maptankx2]==0||MAP_Global[maptanky2][maptankx2]>10){
        check10=0;
    }
    if(MAP_Global[maptanky3][maptankx3]==4||MAP_Global[maptanky3][maptankx3]==0||MAP_Global[maptanky3][maptankx3]>10){
        check11=0;
    }
    if(MAP_Global[maptanky4][maptankx4]==4||MAP_Global[maptanky4][maptankx4]==0||MAP_Global[maptanky4][maptankx4]>10){
        check12=0;
    }
    if(control_mode==1){
