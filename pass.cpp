...
//        connect(l2btn,&QPushButton::clicked,[=](){
//            QTimer::singleShot(500,this,[=](){
//                this->hide();
//                Level2->show();

//                connect(Level2,&level2::Win,[=](){
//                    pass_judge[1]=true;
//                    setupLevel2Button(l3btn,Level3,l4btn);
//                    colorChange(l2btn);
//                    this->show();
...
//        connect(l3btn,&QPushButton::clicked,[=](){
//            QTimer::singleShot(500,this,[=](){
//                this->hide();
//                Level2->show();

//                connect(Level3,&level3::Win,[=](){
//                    pass_judge[2]=true;
//                    setupLevel3Button(l4btn,Level4);
//                    colorChange(l3btn);
//                    this->show();
...
//        connect(l4btn,&QPushButton::clicked,[=](){
//            QTimer::singleShot(500,this,[=](){
//                this->hide();
//                Level4->show();

//                connect(Level4,&level4::Win,[=](){
//                    pass_judge[3]=true;
//                    colorChange(l4btn);
//                    this->show();
//                    Level4->close();
...
//                connect(Level4,&level4::back,this,[=](){
//                    this->show();
//                    Level4->close();
//                });
//            });
